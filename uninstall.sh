...
ENV_FILE="${HOME}/.config/environment.d/ai-assistant.conf"
...
rm -f "${INSTALL_DIR}/kcm-launch.sh"
echo "  -> Removed ${INSTALL_DIR}/kcm-launch.sh"
...
echo "Removing KCM plugin..."
rm -f "${PLUGIN_DIR}/kcm_ai_assistant.so"
echo "  -> Removed ${PLUGIN_DIR}/kcm_ai_assistant.so"
rm -f "${HOME}/.local/share/applications/kcm_ai_assistant.desktop"
echo "  -> Removed kcm_ai_assistant.desktop"

echo "Removing QT_PLUGIN_PATH config..."
rm -f "${ENV_FILE}"
